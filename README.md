# Lab 4 - *ParseChat-CodePath*

**ParseChat-CodePath** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
<img src='https://i.imgur.com/FyDpXTF.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
